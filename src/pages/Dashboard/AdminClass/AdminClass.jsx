...
//                                     </td>
//                                     <td className="py-5">{classItem.title}</td>
//                                     <td className="py-5">{classItem.description.length > 100
//                                         ? `${classItem.description.slice(0, 50)}...`
//                                         : classItem.description}</td>
...
//                     <div className="mt-10 flex flex-col md:flex-row justify-center md:justify-between items-center gap-3">
//                         <div>
//                             <span className="text-gray-800">Page {currentPage + 1} of {Math.ceil(data.length / itemsPerPage)}</span>
//                         </div>
//                         <div>
//                             <ReactPaginate
//                                 previousLabel={
