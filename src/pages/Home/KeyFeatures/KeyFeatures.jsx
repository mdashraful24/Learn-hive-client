...
const KeyFeatures = () => {
    ...
    // if (isLoading) {
    //     return <div className="text-white text-center py-12 text-lg font-semibold">Fetching key features, please wait...</div>;
    // }

    // if (isError) {
    //     return <div className="text-red-500 text-center py-12 text-lg font-semibold">Oops! Unable to load key features. Please try again later.</div>;
    // }
                    ...
                    <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-8 px-2.5">
                        {isLoading ? (
                            <div className="col-span-1 md:col-span-2 lg:col-span-3 flex justify-center items-center py-12">
                                ...
                                {/* <div className="w-12 h-12 border-4 border-gray-200 border-t-purple-700 rounded-full animate-spin"></div> */}
                            </div>
                        ) : (
