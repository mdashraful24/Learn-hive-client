                ...
                <div className="navbar">
                    ...
                    <div className="navbar-end">
                        {user ? (
                            ...
                            <Link
                                to="/login"
                                className="bg-primary text-xs md:text-base text-white font-medium px-3 md:px-4 py-2 rounded-lg mr-2 md:mr-3 transition-transform duration-500 ease-in-out hover:scale-110"
                            >
                                Sign In
                            </Link>
                        )}
